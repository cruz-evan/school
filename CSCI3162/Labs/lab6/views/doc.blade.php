...
<div class="ui grid">
    ...
    <div class="two wide column">
        <div class="ui link list">
          <a href="#fitem" class="item">First link</a>
          <a href="#sitem" class="item">Second link</a>
          <a href="#titem" class="item">Third link</a>
          <a href="#foitem" class="item">Fourth link</a>
          <a href="#litem" class="item">Fith link</a>
        </div>
    </div>
	<div class="twelve wide column">
		<div class="ui vertical stripe segment">    	
            <h2 class="ui black header" id="fitem">
                ITEM 1
            </h2>
            <p>
            ...
            <h2 class="ui black header" id="sitem">
                ITEM 2
            </h2>
            <p>
            ...
            <h2 class="ui black header" id="titem">
                ITEM 3
            </h2>
            <p>
            ...
            <h2 class="ui black header" id="foitem">
                ITEM 4
            </h2>
            <p>
            ...
            <h2 class="ui black header" id="litem">
                ITEM 5
            </h2>
            <p>
